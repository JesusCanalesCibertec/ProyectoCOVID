...
*/
    [Table("PM_NOTIFICACION", Schema = "sgseguridadsys")]
    public class PmNotificacion : PmNotificacionPk
    {
        [Column("TITULO")]
        ...
        [Column("PROCESO_ACCION")]
        public String ProcesoAccion { get; set; }

        [Column("PROCESO_PARAMETROS")]
        public String ProcesoParametros { get; set; }

        [Column("PROCESO_ID_TRANSACCION")]
        public Nullable<Int32> ProcesoIdTransaccion { get; set; }

        [Column("FUENTE_NOTIFICACION")]
        public String FuenteNotificacion { get; set; }
