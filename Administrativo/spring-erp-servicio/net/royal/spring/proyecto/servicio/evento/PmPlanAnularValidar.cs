...
{
    public class PmPlanAnularValidar : BpValidarServicio
    {
        ...
        public PmPlanAnularValidar(IServiceProvider _servicioProveedor)
        {
        ...
        public MensajeResultado validar(UsuarioActual usuarioActual, BpTransaccion bpTransaccion, BpProcesoconexion bpProcesoConexion)
        {
            ...
            List<DtoTarea> lst = pmTareaDao.listarTareasFinalizadasExitosamente(usuarioActual, pmProyecto);
            ...
            {
                msg.FlgValido = false;
                String str = "Se tiene tareas finalizadas exitosamente, se debe finalizar o anular las tareas pendientes y finalizar el plan";
