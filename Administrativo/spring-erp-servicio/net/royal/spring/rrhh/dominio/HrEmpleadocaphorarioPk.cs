...
*/
public class HrEmpleadocaphorarioPk {
	...
	public Nullable<Int32> Secuencia  { get; set; }
        ...
        public HrEmpleadocaphorarioPk() {
        }

        public HrEmpleadocaphorarioPk(String pCompanyowner,String pCapacitacion,Nullable<Int32> pEmpleado,Nullable<Int32> pSecuencia) {
