...
{
    public class GenericoDaoImpl<T> : GenericoDao<T> where T : class
    {
        protected GenericoDbContext _context;
        ...
        public GenericoDaoImpl(GenericoDbContext context, String nombreAlias)
        {
            _context = context;
        ...
        public GenericoDbContext getContext()
        {
            return _context;
        }
