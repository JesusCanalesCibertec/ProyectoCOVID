...
namespace net.royal.spring.programasocial.dominio {
     ...
     * 
     * 
     * @tabla sgseguridadsys.PS_SALUD_DISCAPACIDAD
*/
    [Table("PS_SALUD_DISCAPACIDAD", Schema = "sgseguridadsys")]
    public class PsSaludDiscapacidad : PsSaludDiscapacidadPk {
