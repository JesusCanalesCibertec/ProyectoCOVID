...
*/
[Table("PS_SALUD_BIOMECANICA", Schema = "sgseguridadsys")]
public class PsSaludBiomecanica: PsSaludBiomecanicaPk {

	
	[Display(Name = "ID_ESTADO_AYUDA")]
	[MaxLength(6)]
	[Required(ErrorMessage = " El campo {0} no puede estar vacio " )]
	[Column("ID_ESTADO_AYUDA")]
