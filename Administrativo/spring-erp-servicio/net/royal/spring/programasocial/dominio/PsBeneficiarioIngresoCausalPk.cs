 ...
 * 
 * 
 * @tabla sgseguridadsys.PS_BENEFICIARIO_INGRESO_CAUSAL
*/
public class PsBeneficiarioIngresoCausalPk {
	...
	[Key]
	[Display(Name = "ID_CAUSAL")]
	[MaxLength(5)]
	[Required(ErrorMessage = " El campo {0} no puede estar vacio " )]
	[Column("ID_CAUSAL")]
	public String IdCausal  { get; set; }

        public PsBeneficiarioIngresoCausalPk() {
        }

        public PsBeneficiarioIngresoCausalPk(String pIdInstitucion,Nullable<Int32> pIdBeneficiario,Nullable<Int32> pIdIngreso,String pIdCausal) {
	...
	this.IdCausal = pIdCausal;
        ...
        {
            object[] myObjArray = { IdInstitucion,IdBeneficiario,IdIngreso,IdCausal };
            return myObjArray;
        }
 }
}
