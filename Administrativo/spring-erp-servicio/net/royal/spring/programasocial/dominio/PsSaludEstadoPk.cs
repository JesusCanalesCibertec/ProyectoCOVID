...
*/
    public class PsSaludEstadoPk {
        ...
        public PsSaludEstadoPk() {
        }

        public PsSaludEstadoPk(String pIdInstitucion, Nullable<Int32> pIdBeneficiario, Nullable<Int32> pIdSalud, String pIdEstado) {
        ...
        public object[] obtenerArreglo() {
            object[] myObjArray = { IdInstitucion, IdBeneficiario, IdSalud, IdEstado };
            return myObjArray;
        }
    }
}
