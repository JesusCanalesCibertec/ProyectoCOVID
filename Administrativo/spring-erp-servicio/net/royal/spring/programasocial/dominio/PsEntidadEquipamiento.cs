...
*/
    [Table("PS_ENTIDAD_EQUIPAMIENTO", Schema = "sgseguridadsys")]
    public class PsEntidadEquipamiento : PsEntidadEquipamientoPk
    {
        ...
        [NotMapped]
        public String auxEquipamiento { get; set; }

        public PsEntidadEquipamiento()
        {
        }
    }
}
