...
*/
    [Table("PS_ENTIDAD_PROGRAMA_SOCIAL", Schema = "sgseguridadsys")]
    public class PsEntidadProgramaSocial : PsEntidadProgramaSocialPk
    {

        [Display(Name = "PROGRAMA_SOCIAL")]
        [MaxLength(20)]
        [Column("PROGRAMA_SOCIAL")]
        ...
        public PsEntidadProgramaSocial()
        {
        }
    }
}
