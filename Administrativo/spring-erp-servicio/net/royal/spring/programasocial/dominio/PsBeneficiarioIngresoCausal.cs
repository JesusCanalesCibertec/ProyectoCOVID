...
*/
    [Table("PS_BENEFICIARIO_INGRESO_CAUSAL", Schema = "sgseguridadsys")]
    public class PsBeneficiarioIngresoCausal : PsBeneficiarioIngresoCausalPk
    {
        ...
        [NotMapped]
        public String auxCausal { get; set; }

        public PsBeneficiarioIngresoCausal()
        {
        }
    }
}
