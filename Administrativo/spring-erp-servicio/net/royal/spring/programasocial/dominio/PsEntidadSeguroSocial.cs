...
*/
    [Table("PS_ENTIDAD_SEGURO_SOCIAL", Schema = "sgseguridadsys")]
    public class PsEntidadSeguroSocial : PsEntidadSeguroSocialPk
    {

        [Display(Name = "SEGURO_SOCIAL")]
        [MaxLength(20)]
        ...
        [NotMapped]
        public String auxSeguro { get; set; }

        public PsEntidadSeguroSocial()
        {
        }
    }
}
