...
*/
[Table("PS_BENEFICIARIO_INGRESO_DIAGNOSTICO", Schema = "sgseguridadsys")]
public class PsBeneficiarioIngresoDiagnostico: PsBeneficiarioIngresoDiagnosticoPk {
	...
	public String ModificacionTerminal  { get; set; }
        ...
        public PsBeneficiarioIngresoDiagnostico()
        {
        }
 }
}
