...
*/
[Table("PS_CONSUMO_PLANTILLA_DETALLE", Schema = "sgseguridadsys")]
public class PsConsumoPlantillaDetalle: PsConsumoPlantillaDetallePk {
	...
	public String ModificacionTerminal  { get; set; }
        ...
        public PsConsumoPlantillaDetalle()
        {
        }
 }
}
