...
*/
    [Table("PS_ENTIDAD_PARIENTE", Schema = "sgseguridadsys")]
    public class PsEntidadPariente : PsEntidadParientePk
    {

        [Display(Name = "ID_PARENTESCO")]
        [MaxLength(5)]
        ...
        [NotMapped]
        public String auxParentesco { get; set; }

        public PsEntidadPariente()
        {
        }
    }
}
