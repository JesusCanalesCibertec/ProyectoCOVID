...
*/
[Table("PS_CONSUMO_PLANTILLA", Schema = "sgseguridadsys")]
public class PsConsumoPlantilla: PsConsumoPlantillaPk {
	...
	public String ModificacionTerminal  { get; set; }
        ...
        [NotMapped]
        public List<PsConsumoPlantillaDetalle> listadetalle;

        public PsConsumoPlantilla()
        {
            listadetalle = new List<PsConsumoPlantillaDetalle>();
        }
    }
}
