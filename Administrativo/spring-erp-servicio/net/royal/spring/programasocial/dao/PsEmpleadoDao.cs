...
namespace net.royal.spring.programasocial.dao
{
    ...
    public interface PsEmpleadoDao : GenericoDao<PsEmpleado>
    {
        PsEmpleado obtenerPorId(String pIdInstitucion,Nullable<Int32> pIdEmpleado);
        PsEmpleado coreActualizar(UsuarioActual usuarioActual, PsEmpleado bean, String estado);
        PsEmpleado coreInsertar(UsuarioActual usuarioActual, PsEmpleado bean, String estado);
        ...
        List<Empleadomast> listarPorCorreoInterno(string correo);
    }
}
