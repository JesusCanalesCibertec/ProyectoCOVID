...
{
    public interface BpMaeprocesoelementofuncionalidadDao : GenericoDao<BpMaeprocesoelementofuncionalidad>
    {
        String obtenercodigo(BpMaeprocesoelementofuncionalidadPk bean);
