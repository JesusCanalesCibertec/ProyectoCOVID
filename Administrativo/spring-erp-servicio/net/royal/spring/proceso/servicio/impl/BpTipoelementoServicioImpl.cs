...
namespace net.royal.spring.proceso.servicio.impl
{
    ...
    public class BpTipoelementoServicioImpl : GenericoServicioImpl, BpTipoelementoServicio
    {

        private IServiceProvider servicioProveedor;
        private BpTipoelementoDao BpTipoelementoDao;


        public BpTipoelementoServicioImpl(IServiceProvider _servicioProveedor)
        {
            servicioProveedor = _servicioProveedor;
            BpTipoelementoDao = servicioProveedor.GetService<BpTipoelementoDao>();
        }

        public List<BpTipoelemento> listarTodos()
        {
            return BpTipoelementoDao.listarTodos();
        }
    }
}
